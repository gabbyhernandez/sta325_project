...
group_indices <- list(c("Hepatitis.B", "Polio", "Diphtheria"), c("Adult.Mortality", "under.five.deaths", "HIV.AIDS"), c("percentage.expenditure", "GDP", "Income.composition.of.resources"), c("Alcohol", "Population", "BMI"))
